...
class GildedRoseTest {
    ...
    void conjured_items_degrade_in_quality_twice_as_fast() {
        ...
        Item conjuredItem = new Item("Conjured", startingSellin, startingQuality);
        GildedRose subject = new GildedRose(new Item[] {conjuredItem});

        subject.updateItems();

        assertThat(conjuredItem.sellIn).isEqualTo(9);
    ...
    void conjured_items_degrade_in_quality_by_four_if_expired() {
        ...
        assertThat(conjuredItem.quality).isEqualTo(16);
    }
    @Test
    void conjured_items_can_never_be_negative() {
        int startingSellin = 10;
